...
<section class="py-5">
    <div class="container" id="planes">
        <h1 class="fw-bold text-primary-veris text-center">Escoge la opción ideal para ti</h1>
        <div class="row justify-content-center px-xxl-5">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-8">
                ...
                <p class="text-center text-fiord-700 fw-semibold mb-5">Esto cubrimos / no cubrimos</p>
