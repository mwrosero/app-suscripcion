            ...
            <div class="modal-body p-0">
                <div id="addBeneficiaryForm" class="pt-3">
                    ...
                    <div class="row g-3 justify-content-center">
                        ...
                        <div class="col-12 col-md-10 d-none" id="parentesco-col">
                            ...
                            <div class="col-12 col-md-10 d-none" id="privacy-col">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label fs-10p" for="privacy">
                                        He leído y comprendo la autorización para el <a href="https://www.veris.com.ec/politicas/" class="text-mariner-600 text-decoration-underline" nemonico-rel="TRATAMIENTO_DATOS">Tratamiento de mis datos personales</a>
                                    </label>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row g-3 justify-content-center">
            ...
            <div class="col-12 mb-4">
                <div class="card shadow-none mb-4">
                    <div class="card-header">
                        <div class="row g-3 align-items-center justify-content-between">
                            <div class="col-12 col-md-8 col-lg-9 d-flex align-items-center justify-content-center justify-content-md-start gap-4 mb-2 mb-md-0">
                                <h5 class="mb-0 text-secondary fw-normal fs-18 line-height">Beneficiarios</h5>
                            ...
                            <div class="col-12 col-md-4 col-lg-3 justify-content-end">
                                <div class="row g-3 justify-content-end">
                                    <div class="col-12">
                                        <button type="button" class="btn btn-lg btn-blue-veris fw-medium fs-14p shadow-none w-100" data-bs-toggle="modal" data-bs-target="#addBeneficiaryModal"><i class="fa-solid fa-plus me-2"></i> Añadir beneficiario</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex gap-3 justify-content-center">
                    <a href="/" class="btn btn-cerulean-blue-800">Ir al dashboard</a>
                </div>
            </div>
        </div>
    </section>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', async () => {
        ...
        $('body').on('click', '#btn-add', async function () {
            if (!validado) {
                ...
                let camposCompletos = await verificarCamposFormulario();
                if(!camposCompletos){
                    return;
                }
        ...
        $('#addBeneficiaryModal').on('show.bs.modal', function () {
            ...
            $('#nombre-col, #apellido-col, #sapellido-col, #fecha-col, #genero-col, #parentesco-col, #email-col, #telefono-col, #terms-col, #privacy-col')
                .addClass('d-none');
    ...
    async function cargaAfiliadosSuscripcion(){
        ...
        let itemPaciente = {
            ...
            "codigoTipoParentesco": parseInt(parentesco),
            "idPacienteTitular": {{ Session::get('infoCliente')->idPaciente  }} 
        };
 ...
 --}}
    ...
    async function existeIdentificionSuscrita(numero){
        ...
        if(response.data === null || response.data.totalRows == 0){
            return false;
        }
