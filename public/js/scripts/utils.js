document.addEventListener("DOMContentLoaded", () => {
    ...
    sliders.forEach((slider) => {
        ...
        const breakpoints = slider.dataset.breakpoints
            ? JSON.parse(slider.dataset.breakpoints)
            : {};
        const autoplayConfig = slider.dataset.autoplay
            ? JSON.parse(slider.dataset.autoplay)
            : false;
        ...
        const config = {
            ...
            breakpoints: slider.dataset.breakpoints
                ? JSON.parse(slider.dataset.breakpoints)
                : {},
        };
